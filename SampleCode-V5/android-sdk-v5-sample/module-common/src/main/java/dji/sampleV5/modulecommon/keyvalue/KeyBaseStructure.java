...
public class KeyBaseStructure<P, R>   {
    ...
    protected void initGenericInstance() {
        try {
            dji.sampleV5.modulecommon.keyvalue.KeyItemHelper.INSTANCE.initClassData(param);
            dji.sampleV5.modulecommon.keyvalue.KeyItemHelper.INSTANCE.initClassData(result);
            initSubItemData();
        } catch (Exception e) {
    ...
    protected void initSubItemData() {
        ...
        subItemMap.clear();
        subItemMap.putAll(dji.sampleV5.modulecommon.keyvalue.KeyItemHelper.INSTANCE.initSubItemData(param));
    }
