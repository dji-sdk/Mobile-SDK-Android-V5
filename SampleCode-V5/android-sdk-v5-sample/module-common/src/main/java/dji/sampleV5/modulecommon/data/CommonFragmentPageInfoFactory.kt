...
class CommonFragmentPageInfoFactory : IFragmentPageInfoFactory {
    ...
    override fun createPageInfo(): FragmentPageInfo {
        return FragmentPageInfo(R.navigation.nav_common).apply {
            ...
            items.add(FragmentPageInfoItem(R.id.media_playback_page, R.string.item_media_playback_title, R.string.item_media_playback_description))
            ...
            items.add(FragmentPageInfoItem(R.id.key_login_account_page, R.string.item_login_account_title, R.string.item_login_account_description))
            items.add(FragmentPageInfoItem(R.id.key_log_info_page, R.string.item_log_info_title, R.string.item_log_info_description))
