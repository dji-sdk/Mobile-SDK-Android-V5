 ...
 */
public class ExposureMeterWidgetModel extends WidgetModel implements ICameraIndex {
    ...
    public ExposureMeterWidgetModel(@NonNull DJISDKModel djiSdkModel, @NonNull ObservableInMemoryKeyedStore uxKeyManager) {
